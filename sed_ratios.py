...
apparent_file = np.loadtxt ( 'WISEU_J050305.68-564834.0/WISEU_J050305.68-564834.0_apparent_SED.txt' , skiprows=3)
...
fig_app , ax_app = plt.errorbar( wavelength_microns , apparent_flux , yerr= apparent_flux_error, title='WISEU_J050305.68-564834.0', xlabel=r'wavelength[$\mu$]' , ylabel='Apparent flux[Jy]' , xlim=[3.6,5.] , ylim=[0, .5e-17] , label="flux" , markerstyle='.' , color='black' , markersize=2 , linewidth=2 , ecolor='black' , alpha=.2,  )
# ax_app.grid()
